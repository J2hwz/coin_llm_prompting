...
from coinenv.agents.agent_abc import Agent
...
def generate_trajectories(
    ...
    Trajectory and Step data models as defined in `coinenv.datatypes`.
    ...
    - This is a definition-only stub; an implementation should mirror the control
      ...
      truncated or max_steps_per_trajectory.
        ...
        - When save_dir is provided, each generated trajectory will be written as a
            JSON file compliant with `coinenv.datatypes.load_trajectory_from_file` schema:
                {
                    "steps": [
        ...
        Example
        from coinenv.trajectory_generator.policies import random_policy
